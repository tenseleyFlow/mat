...
HDRS = src/compat.h src/config.h src/config_generated.h src/err.h \
       ...
       src/range.h src/linesrc.h src/rangeprint.h src/frame.h src/encoding.h src/ansi.h src/syntax.h lib/paige/include/paige.h
...
OBJS = build/main.o build/cli.o build/err.o build/iobuf.o \
       ...
       build/range.o build/linesrc.o build/rangeprint.o build/frame.o build/encoding.o build/ansi.o build/syntax.o $(PAIGE_OBJS)
